...
public interface DisciplinaRepository extends JpaRepository<Disciplina, Long> {
    ...
    @Query(nativeQuery = true, value = """
            SELECT tb_disciplina.id, tb_disciplina.codigo_disciplina AS codigoDisciplina, tb_disciplina.nome_disciplina AS nomeDisciplina,
             tb_disciplina.num_periodo AS numPeriodo, tb_disciplina.quant_creditos AS quantCreditos, tb_disciplina.sigla, tb_belonging_periodo.position
             FROM tb_disciplina
